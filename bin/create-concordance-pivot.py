...
# create function that preps the cycle data
def prep_cycle_data(cycle_table: pl.DataFrame, results_files: list):
...
# create a function that reorients the concordance pivot according to relationships
def reorient_with_manifest(concordance_table: pl.DataFrame, sample_manifest: str):
...
# create a function that generates the pivot
def generate_pivot(cycle_table: str, sample_manifest: str, results_files: str):
  ...
  # create empty concordance pivot
  concordance_table = prep_cycle_data(cycle_table, results_files)
...
final_table = generate_pivot(cycle_table, sample_manifest, results_files)
